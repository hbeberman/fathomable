...
fn thread_list(app: &mut App, key: KeyEvent, ctrl: bool) {
    ...
    match (key.code, ctrl) {
        ...
        (KeyCode::Char('j') | KeyCode::Down, _) => app.thread_list_message_move(1),
        (KeyCode::Char('k') | KeyCode::Up, _) => app.thread_list_message_move(-1),
        (KeyCode::Char('h'), _) => app.thread_list_step(-1),
        (KeyCode::Char('l'), _) => app.thread_list_step(1),
        (KeyCode::Char('d'), true) | (KeyCode::PageDown, _) => app.thread_list_step(half),
        (KeyCode::Char('u'), true) | (KeyCode::PageUp, _) => app.thread_list_step(-half),
        ...
        (KeyCode::Char('e'), _) => app.thread_list_edit_message(),
