...
impl App {
    ...
    /// [`crate::app::view::View::set_detached_anchors`].
    ...
    /// its marks changed.
    pub(crate) fn place_detached_rows(&mut self) {
    ...
    /// thread first.
    pub(crate) fn detached_marks_at(&self, anchor: usize) -> impl Iterator<Item = &Mark> {
        self.marks()
            .iter()
