...
| `thread.cursor` | the `▎` bar down the thread cursor's message and on its thread's header ([0071](0071-author-stripes.md)), and on the file row over it in the review list ([0077](0077-threads-nest-under-their-file.md)) |
