...
72. **The persistent menu bar.** A compact `☰  Go  Review  Diff` row
    ...
    only the active comparison controls, the sidebar restores as one unit,
    Help gains Getting started, Doctor, and View keymap, and every popup uses
    a rounded titled border
